  ...
  programs = {
    nushell = {
      ...
      extraConfig = ''
        ...
        def full-clean [...args] {nix-collect-garbage -d; sudo nix-collect-garbage -d}
               def rebuild [...args] {sudo nixos-rebuild switch --flake ~/nixos-config#main-config}
               def full-rebuild [...args] {sudo nixos-rebuild switch --flake ~/nixos-config#main-config; home-manager switch --flake ~/nixos-config#home-config}
               def home-rebuild [...args] {home-manager switch --flake ~/nixos-config#home-config}
